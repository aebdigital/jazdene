  ...
  return (
    <>
      ...
      <div className="block md:hidden mb-6 relative">
        <div className="w-full aspect-[4/3] bg-white/5 border border-white/10 overflow-hidden relative backdrop-blur-sm">
          ...
          {images.length > 1 && (
            <>
              <button
                ...
                className="absolute left-2 top-1/2 -translate-y-1/2 bg-black/50 text-white p-2  hover:bg-black/70 transition-colors"
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/50 text-white p-2  hover:bg-black/70 transition-colors"
              ...
              <div className="absolute bottom-2 right-3 bg-black/50 text-white text-xs px-2 py-1 ">
      ...
      {lightboxOpen && (
        ...
        >
          ...
          <button
            onClick={closeLightbox}
            className="absolute top-4 right-4 text-white bg-white/20 hover:bg-white/40  w-10 h-10 flex items-center justify-center text-2xl transition-colors"
            aria-label="Zavrieť"
          >
            ×
          </button>
          ...
          <button
            ...
            className="absolute left-4 text-white bg-white/20 hover:bg-white/40  w-10 h-10 flex items-center justify-center text-xl transition-colors"
          ...
          <button
            ...
            className="absolute right-4 text-white bg-white/20 hover:bg-white/40  w-10 h-10 flex items-center justify-center text-xl transition-colors"
            aria-label="Ďalšia"
          >
            ›
          </button>
          {/* Counter */}
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 text-white/70 text-sm font-montserrat bg-black/40 px-3 py-1 ">
