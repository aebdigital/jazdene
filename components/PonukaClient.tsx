    ...
    <aside className="w-full space-y-5">
      ...
      <div>
        ...
        <input
          ...
          className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm font-montserrat focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500"
        />
      </div>
      ...
      <div>
        ...
        <select
          ...
          className="w-full border border-gray-700 bg-gray-800 text-white rounded-lg px-3 py-2 text-sm font-montserrat focus:outline-none focus:border-green-500"
        >
      ...
      <div>
        ...
        <div className="flex gap-2">
          <input type="number" placeholder="Od" value={filters.priceMin} onChange={e => setFilter('priceMin', e.target.value)} className="w-1/2 border border-gray-200 rounded-lg px-3 py-2 text-sm font-montserrat focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500" min={0} />
          <input type="number" placeholder="Do" value={filters.priceMax} onChange={e => setFilter('priceMax', e.target.value)} className="w-1/2 border border-gray-200 rounded-lg px-3 py-2 text-sm font-montserrat focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500" min={0} />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex gap-2">
          <input type="number" placeholder="Od" value={filters.yearMin} onChange={e => setFilter('yearMin', e.target.value)} className="w-1/2 border border-gray-200 rounded-lg px-3 py-2 text-sm font-montserrat focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500" min={1990} max={2025} />
          <input type="number" placeholder="Do" value={filters.yearMax} onChange={e => setFilter('yearMax', e.target.value)} className="w-1/2 border border-gray-200 rounded-lg px-3 py-2 text-sm font-montserrat focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500" min={1990} max={2025} />
        </div>
      </div>
      ...
      <div>
        ...
        <input type="number" placeholder="Napr. 100000" value={filters.mileageMax} onChange={e => setFilter('mileageMax', e.target.value)} className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm font-montserrat focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500" min={0} />
      </div>
      ...
      {activeCount > 0 && (
        <button onClick={resetFilters} className="w-full text-sm font-montserrat text-green-400 border border-green-800 hover:bg-green-900/30 py-2 rounded-lg transition-colors">
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="lg:hidden mb-4 flex items-center gap-3">
        <button
          ...
          className="flex items-center gap-2 bg-gray-800 border border-gray-700 text-white rounded-lg px-4 py-2.5 text-sm font-bold font-jakarta shadow-sm hover:border-green-500 transition-colors"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2a1 1 0 01-.293.707L13 13.414V19a1 1 0 01-.553.894l-4 2A1 1 0 017 21v-7.586L3.293 6.707A1 1 0 013 6V4z" />
          </svg>
          Filtre {activeCount > 0 && <span className="bg-green-600 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">{activeCount}</span>}
        </button>
      ...
      {/* Mobile filter panel */}
      {showFilters && (
        <div className="lg:hidden mb-6 bg-gray-800 rounded-xl border border-gray-700 p-5 shadow-sm">
          <FilterPanel />
        </div>
      )}
      ...
      <div className="flex gap-7">
        ...
        <div className="hidden lg:block w-64 flex-shrink-0">
          <div className="bg-gray-800 rounded-xl border border-gray-700 p-5 shadow-sm sticky top-28">
              ...
              {filtered.map((car) => {
                ...
                return (
                  <Link
                    ...
                    className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 overflow-hidden hover:shadow-md hover:-translate-y-1 transition-all duration-200 flex flex-col"
                  >
                    ...
                    <div className="p-4 flex flex-col flex-1">
                      ...
                      <div className="border-t border-gray-700 pt-3">
                        <p className="text-xl font-bold font-jakarta text-green-400">
