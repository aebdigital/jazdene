...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-gray-950 pt-32 pb-20 text-white">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-6 rounded-2xl border border-green-900 bg-green-950/40 px-6 py-5 font-montserrat text-base leading-8 text-gray-200">
            <strong>Autocentrumbb s.r.o.</strong><br />
            Zvolenská cesta 3492/141 974 05 Banská Bystrica<br />
            IČO: 47421410, DIČ: 2023860553 IČ DPH: SK2023860553<br />
            E-mail: info@autocentrumbb.sk<br />
            Tel.: +421 905 241 887
          </p>
          <div className="mt-8 space-y-8 font-montserrat text-gray-300">
            ...
            <section className="rounded-3xl border border-gray-800 bg-gray-900 p-7 shadow-sm">
              <h2 className="font-jakarta text-2xl font-bold text-white">I. Kontaktný formulár</h2>
              <p className="mt-4 text-base leading-8">Na stránke www.autocentrumbb.sk prevádzkujeme kontaktný formulár na dvoch samostatných stránkach, ktorého účelom je umožniť vám:</p>
            ...
            <section className="rounded-3xl border border-gray-800 bg-gray-900 p-7 shadow-sm">
              ...
              <p className="mt-6 text-base leading-8">V prípade otázok alebo uplatnenia Vašich práv nás môžete kontaktovať na info@autocentrumbb.sk alebo telefónnom čísle +421 905 241 887.</p>
            </section>
            <div className="rounded-2xl border border-green-900 bg-green-950/40 px-6 py-5 text-sm font-semibold text-green-300">Tieto Zásady nadobúdajú účinnosť dňom 13.5. 2025.</div>
          </div>
        </div>
      </div>
    </div>
